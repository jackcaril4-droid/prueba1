        ...
        >
          {BRANDS.map((brand) => (
            <motion.div
              ...
              className="group relative aspect-[4/5] overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200/50 dark:border-white/10 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-end p-6 md:p-8"
            >
              {/* Background Image */}
              <Image
                src={brand.image}
